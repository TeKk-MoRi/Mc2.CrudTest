...
{
    public class UpdateCustomerRequestTest : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[] {
                    new UpdateCustomerCommand(new UpdateCustomerRequest
                        {
                            Id = 3,
                            FirstName = "John",
                            LastName = "Doe",
    ...
    public class UpdateCustomerRequestInvalidNoTest : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[] {
